...
class TestMemory(unittest.TestCase):
    ...
    def testWrite(self):
        ...
        self.assertIsNone(self.m.getClusters()[8][1])
        # Escribir datos en el cluster 8
        self.m.write(8, "lala")
        # En el cluster 8 estan los datos que escribimos
        self.assertEquals(self.m.getClusters()[8][1], "lala")
    ...
    def testSetInUse(self):
        ...
        self.assertFalse(self.m.getClusters()[8][0])
        # Testear que el metodo funciona para True
        self.m.setInUse(8, True)
        self.assertTrue(self.m.getClusters()[8][0])
